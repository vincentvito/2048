...
- `GoogleAnalytics` component (`src/components/GoogleAnalytics.tsx`) that wraps gtag.js loading via the Next.js `Script` component with `afterInteractive` strategy. Wired into the root layout with measurement ID G-K0JVX8741F
